...
// TODO
//// key: "name", val: "id"
////　service package関数整理しないと。本だけになっている。
...
func _main() {
	...
	// 貸し出し書籍各3冊
	b1 := mydb.Book{Title: "赤毛のアン", Copy: 3}
	b2 := mydb.Book{Title: "小公女セーラ", Copy: 3}
	b3 := mydb.Book{Title: "フランダースの犬", Copy: 3}
	...
	hellopb.RegisterLendingBooksServiceServer(grpcServer, NewMyServer())
